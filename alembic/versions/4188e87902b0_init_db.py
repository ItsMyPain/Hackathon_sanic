...
Revision ID: 4188e87902b0
Revises: 
Create Date: 2023-08-18 22:17:26.961857
...
def upgrade() -> None:
    ...
    sa.Column('state_id', sa.INTEGER(), server_default='1', nullable=False),
    ...
    sa.Column('user_id', sa.INTEGER(), nullable=False),
    sa.Column('data', postgresql.ARRAY(sa.REAL()), nullable=False),
